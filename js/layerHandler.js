...
//   var viewResolution = /** @type {number} */ (mapInstance.getView().getResolution());
//   var url = layerHandler.constructWms("topp","states","US polygons").getSource().getGetFeatureInfoUrl(
...
//       var str ='';
//       for (var i = 0 in data.features[0].properties) {
//         //console.log(i+": "+data.features[0].properties[i]);
//         str = str+i+": "+data.features[0].properties[i]+"<br />";
//         ///str = str.replace(/\n/g, "<br />");
//       }
//       //console.log(str);
//       $("#infoBoard").html(str);
